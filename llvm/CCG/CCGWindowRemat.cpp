//===-- CCGWindowRemat.cpp - keep window arithmetic block-local ----------===//
//
...
#define DEBUG_TYPE "ccg-window-remat"
...
class CCGWindowRemat : public FunctionPass {
public:
  static char ID;
  CCGWindowRemat() : FunctionPass(ID) {}
  bool runOnFunction(Function &F) override { return runOnFn(F); }
  StringRef getPassName() const override {
    return "CCG window rematerialization";
  }
...
char CCGWindowRemat::ID = 0;

FunctionPass *llvm::createCCGWindowRemat() { return new CCGWindowRemat(); }
