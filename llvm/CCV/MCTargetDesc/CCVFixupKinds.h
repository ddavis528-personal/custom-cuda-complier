...
//
//===----------------------------------------------------------------------===//
#ifndef CCV_MCTARGETDESC_CCVFIXUPKINDS_H
#define CCV_MCTARGETDESC_CCVFIXUPKINDS_H
...
enum Fixups {
  ...
  fixup_ccv_bra21 = FirstTargetFixupKind,
  ...
  /// instruction. Selected optimistically and relaxed to fixup_ccv_bra21 when
