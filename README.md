...
| File | Role |
|---|---|
| [`docs/isa-v1.2-operation-map-and-encoding.md`](docs/isa-v1.2-operation-map-and-encoding.md) | Ground truth for encoding. Formats, opcode maps, design invariants, open items. |
...
Phase 0 — contract definition. No code yet. See `docs/roadmap.md` for the
current step and the open questions blocking it.
